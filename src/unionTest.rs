...
pub struct StockStruct {
    ...
    pub epsForward: f32,
    pub epsCurrentYear: f32,
    pub priceEpsCurrentYear: f64,
    ...
    pub averageAnalystRating: String,
    pub tradeable: bool,
    ...
    pub priceHint: i8,
    pub postMarketChangePercent: f64,
    pub postMarketTime: i64,
    pub postMarketPrice: f32,
    pub postMarketChange: f32,
